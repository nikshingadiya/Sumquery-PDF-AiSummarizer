...
def extract_information(file_path):
    ...
    for scene_match in scenes:
        ...
        if scene_match.group(5) is not None:
            ...
            transitions_pattern = re.compile(r'^\s*(CUT TO:|FADE TO BLACK:|DISSOLVE TO:|FADE IN:)\s*$', re.MULTILINE)
    ...
    # Add extra information to the extracted data
    for extra_info in extra_info_matches:
        extracted_data["Extra Information"].append(extra_info.strip())
